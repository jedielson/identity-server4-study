...
using JediIdentityServerWithAspNetIdentity.Models.AccountViewModels;
using JediIdentityServerWithAspNetIdentity.Quickstart;
using JediIdentityServerWithAspNetIdentity.Quickstart.Account;
...
namespace JediIdentityServerWithAspNetIdentity.Controllers
{
    [Authorize]
    [SecurityHeaders]
